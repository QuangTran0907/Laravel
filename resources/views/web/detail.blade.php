			...
			<div class="cont span_2_of_3">
				<div class="labout span_1_of_a1">
					...
					<ul id="etalage">
                        ...
                        <li>
							...
							<img class="etalage_source_image" src="{{ asset("images/$item->image_path")}}" />
						</li>
                        @endforeach
				...
				<div class="cont1 span_2_of_a1">
					...
					<div class="price_single">
						...
						<span class="actual">${{$product->price }}</span><a href="#"></a>
					</div>
					<ul class="options">
						<h4 class="m_9">Select a Size</h4>
                        @foreach ($size_product as $item)
                        <li><a href="#">{{ $item->Size->size }}</a></li>
                        @endforeach
					...
					<ul class="add-to-links">
						<li><img src="{{ asset('img/wish.png')}}" alt="" /><a href="#">Add to wishlist</a></li>
					</ul>
				...
				<ul id="flexiselDemo3">
					<li><img src="{{ asset('img/pic11.jpg')}}" />
						<div class="grid-flex"><a href="#">Bloch</a>
							<p>Rs 850</p>
						</div>
					</li>
					<li><img src="{{ asset('img/pic10.jpg')}}" />
						<div class="grid-flex"><a href="#">Capzio</a>
							<p>Rs 850</p>
						</div>
					</li>
					<li><img src="{{ asset('img/pic9.jpg')}}" />
						<div class="grid-flex"><a href="#">Zumba</a>
							<p>Rs 850</p>
						</div>
					</li>
					<li><img src="{{ asset('img/pic8.jpg')}}" />
						<div class="grid-flex"><a href="#">Bloch</a>
							<p>Rs 850</p>
						</div>
					</li>
					<li><img src="{{ asset('img/pic7.jpg')}}" />
						<div class="grid-flex"><a href="#">Capzio</a>
							<p>Rs 850</p>
						</div>
					</li>
